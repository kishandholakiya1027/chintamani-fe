...
const ProductHeader = ({ submitHandler }: any) => {
    ...
    return (
        <>
            <div className="pl-0 w-full border-b-[1px] border-[#eee] flex items-stretch justify-center flex-wrap mb-10">
            ...
            {category?.[category?.length - 1]?.description && <div className='mb-[50px]'>
