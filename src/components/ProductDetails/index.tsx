    ...
    <div className="flex flex-col">
      <span className="self-center flex w-full container flex-col mt-24 max-md:max-w-full max-md:mt-10">
        ...
        <div className="flex flex-col gap-8 md:flex-row">
          ...
          <div className="flex flex-col">
            <div className="text-neutral-700 lg:text-3xl md:text-4xl text-2xl font-bold lg:leading-10 md:leading-10 leading-8 mt-10 self-start lg:ml-2.5 md:ml-2.5 ml-0 max-md:mt-10">
              {product?.maintitle}
            </div>
            <div className="flex max-w-full items-stretch justify-between gap-0.5  mt-7 self-start max-md:flex-wrap">
              <div className="text-neutral-700 ml:2 lg:text-4xl md:text-4xl text-2xl font-bold lg:leading-[57.6px] md:leading-[57.6px] leading-[34px] max-md:max-w-full">
                {product?.title}
              </div>
