...
const WishListProducts = () => {
  ...
  return (
    <div className="container mx-auto py-6">
      <div className="my-8">
        <p className=" text-[30px] text-[#404040] font-bold line-height-[20px]">
          My wishlist
        </p>
      </div>
      {loader ? <Loader /> : null}
            ...
            return (
              ...
              >
                <img
                  ...
                  alt="product-image"
                  className="sm:w-[100px] w-[80px] rounded-lg sm:h-[90px] "
                />
                <div className="w-full justify-between">
                  <div className=" sm:mt-0 flex flex-col gap-2">
                  ...
                  <div className="mt-[3px]">
                    <div
                      ...
                      onClick={() => setOpenPopup(product?.id || "")}
                    >
                      <svg
                    ...
                    {openPopup === product?.id && (
                      <div className="absolute top-2 w-screen left-0 z-50 mt-0 flex max-w-max -translate-x-1/2 px-4">
